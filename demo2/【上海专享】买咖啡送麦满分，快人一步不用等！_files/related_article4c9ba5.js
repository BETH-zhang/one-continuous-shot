...
"use strict";
var n=e("common/comm_report.js"),o=function(){
...
function m(){
dn.mylist.children.length?(l(dn.mylist.parentNode),In||"none"===dn.mine.style.display||ct.removeClass(document.body,En)):(d(dn.mylist.parentNode),
In||"none"===dn.mine.style.display||ct.addClass(document.body,En));
}
function r(){
...
function v(){
var e=dn.showAll,t=Ct.getScrollTop(),n=Ht.getY(e,"js_article");
...
Sendtimestamp:0,
Pos:0
},Dt)),Nt.setSum(110809,26,1),bt.off(window,"scroll",v)),!0);
}
function b(e){
St.report(19462,_extends({
CommentId:parseInt(Zt,10)||0,
...
function I(){
s(dn.expandAndFoldPC)&&(b(1),bt.off(window,"scroll",I));
}
function B(e){
...
function k(e,t,n){
var o=void 0,i=void 0,l="",d="",a=!Jt&&!un||Jt&&Gt||un&&gn,s=document.createElement("div");
...
i.report_elected=i.is_elected||0,i.report_friend=i.is_from_friend||0,i.scene=d,i.supportReply=kn&&i.is_from_me&&a,
...
"en"===window.LANG&&(p.reply_like_num_format=vt.dealLikeReadShow_en(p.reply_like_num)),
...
i.replyListCount=m,i.new_appmsg=window.new_appmsg,l+=Bt.tmpl(pt,i);
try{
...
offset:$t,
url:bn
}))),1!==i.enabled?(Tn&&(Tn.style.display="none"),xn&&d(xn),i.elected_comment=[],
...
if(k(t,m,"elected"),s&&(dn.list.innerHTML=""),dn.list.appendChild(m),l(dn.main),
...
l(document.getElementById("js_cmt_nofans1"),"block")):Rt&&(In?(l(dn.commentPC),l(dn.inputPC)):l(dn.addCmtBtn1)),
...
}else d(dn.main),un&&0===gn?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注3天后才可留言",
...
l(document.getElementById("js_cmt_nofans2"),"block")):Rt&&(In?(l(dn.commentPC),l(dn.inputPC)):l(dn.addCmtBtn2));
n=i.friend_comment,k(n,r,"friend"),n&&0===n.length&&d(xn),s&&(dn.fdlist.innerHTML=""),
dn.fdlist&&dn.fdlist.appendChild(r),n&&n.length?(l(dn.fdmain),(!Jt||Jt&&1===i.is_fans)&&(In||(d(dn.addCmtBtn1),
...
}else t=i.elected_comment,t&&t.length&&(k(t,m,"elected"),dn.list.appendChild(m));
...
l(document.getElementById("js_cmt_qa"))):$t+=i.elected_comment.length,window.ipados13_font_scale&&Lt.setFontSize(dn.main,window.ipados13_font_scale/100);
var _=5;
if(window.user_uin%2===0&&(_=8),t.length>_&&window.has_related_article){
var u=0;
l(dn.showAll),d(document.getElementById("js_cmt_statement"));
for(var g=dn.list.querySelectorAll("li.js_comment_item"),w=0;_>w;w++){
...
dn.listContainer.style.height=u+"px",dn.showAllWording.innerText="查看更多%s条留言".replace("%s",t.length-_);
var j=function(){
if("none"!==dn.showAll.style.display){
for(var e=0,t=dn.list.querySelectorAll("li.js_comment_item"),n=0;_>n;n++){
...
window.addEventListener("resize",j),window.ipados13_font_scale&&(Lt.setFontSize(dn.showAllWording,window.ipados13_font_scale/100),
Lt.onFontScaleChange(j)),Nt.setSum(110809,25,1);
}
...
complete:function(){
en=!1,d(dn.loading),bt.off(window,"scroll",j);
}
});
}
}
...
function P(){
2>=yn?d(dn.expandAndFoldPC):(l(dn.expandAndFoldPC),fn?(ct.addClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="收起我的留言"):(ct.removeClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
...
d(dn.addCmtBtn4)),In&&(d(dn.addCmtBtn1),d(dn.addCmtBtn2),d(dn.addCmtBtn3));
}
function S(e,t){
...
_(),k([o],n,"mine"),dn.mylist.insertBefore(n,dn.mylist.firstChild),m(),In?(dn.input.innerHTML="",
dn.inputHolder.style.display="",dn.containerPC.style.display="none",dn.inputPC.style.display="",
yn++,fn=!0,hn.unshift(o),c(),P()):dn.input.value="",A();
}
function H(e,t){
...
function L(e,t,n,o){
u(o),dn.input.innerHTML="",dn.inputHolder.style.display="",yn++;
...
uin:Ft,
reply_id:e.reply_id
}),a(o,dn.list)?(d(dn.containerPC),k([m],i,"mine"),dn.mylist.insertBefore(i,s),fn?c():r()):(k([m],i,"mine"),
dn.mylist.insertBefore(i,s),fn=!0,c())),P();
}
function M(e){
...
if(n=In?g(sn).replace(/<br\/>/g,"").replace(/\n/g,"")||"":g(dn.input.value),xt.log("tag2"),
!ct.hasClass(dn.submit,"btn_disabled")&&dn.submit.disabled!==!0){
if(xt.log("tag3"),n.length<1)return void p("留言不能为空");
if(xt.log("tag4"),n.length>600)return void p("字数不能多于600个");
In&&(n=sn),xt.log("tag5"),In?dn.submit.disabled=!0:ct.addClass(dn.submit,"btn_disabled"),
xt.log("tag6");
...
complete:function(){
""!==dn.input.value&&ct.removeClass(dn.submit,"btn_disabled");
}
});
}
}
...
function D(e){
R(e),r(),yn>2&&(dn.expandAndFoldPC.innerHTML="展开我的留言",l(dn.expandAndFoldPC),fn=!1,
b(1));
}
function z(){
...
o&&o.length&&(In&&(l(dn.myareaPC),l(dn.mylist)),k(o,i,"mine"),dn.mylist.appendChild(i),
In&&D(o)),rn=2;
...
function U(e){
Kt=Ct.getScrollTop(),In||d(dn.article),l(dn.mine),dn.deletePanel=document.getElementById("js_delete_panel_mobile"),
...
window.__second_open__&&gt.os.ios&&l(dn.fakebar),window.scrollTo(0,0),z(),e||xt.later(function(){
dn.input.focus();
});
}
function W(){
...
window.scrollTo(0,Kt),dn.input.blur(),ct.removeClass(document.body,Bn),ct.removeClass(document.body,En),
...
function J(e,t){
e.parentNode.removeChild(e),ct.addClass(dn.deletePanel,"weui-transition_opacity-hide");
...
function X(e){
var t=void 0,n=e.delegatedTarget,i=n.getAttribute("data-my-id"),l=wt.join("/mp/appmsg_comment",{
action:"delete",
scene:Wt.scene,
appmsgid:window.appmsgid,
my_id:i,
...
ct.removeClass(dn.deletePanel,"weui-transition_opacity-hide"),bt.on(dn.deleteConfirm,"click",function(){
t!==i&&(t=i,It({
url:l,
dataType:"json",
success:function(e){
...
}),bt.on(dn.deleteCancel,"click",function(){
t!==i&&(t=i,ct.addClass(dn.deletePanel,"weui-transition_opacity-hide"));
});
}
function Z(e,t,n){
...
l(dn.deleteReplyPanel),bt.on(dn.deleteReplyConfirm,"click",function(){
t!==a&&(t=a,It({
url:s,
dataType:"json",
success:function(e){
...
}),bt.on(dn.deleteReplyCancel,"click",function(){
t!==a&&(t=a,d(dn.deleteReplyPanel));
});
}
function K(){
dn.input.innerHTML="",dn.input.focus(),jn=null,dn.submit.disabled=!0;
}
function et(e){
...
reply_content:s
}),!0):(In?(dn.containerPC.parentNode.removeChild(dn.containerPC),i.appendChild(dn.containerPC),
...
l(dn.containerPC),K(),wn=!0):(l(dn.updateDialog),Nt.setSum(110809,51,1),bt.on(dn.updateCancel,"click",function(){
d(dn.updateDialog);
}),bt.on(dn.updateConfirm,"click",function(){
...
function nt(e){
e&&e.preventDefault(),G(),d(dn.fakebar);
}
function ot(e,t){
...
function at(){
bt.on(dn.input,"input",function(e){
if(In){
...
n.length<1?ct.addClass(dn.submit,"btn_disabled"):ct.removeClass(dn.submit,"btn_disabled"),
gt.os.ios&&e.data&&Ln.indexOf(e.data)>-1&&(nn=!0);
}),bt.on(dn.input,"click",function(){
gt.os.ios&&nn&&(dn.input.blur(),dn.input.focus(),nn=!1);
}),bt.on(dn.el_alertConfirm,"click",function(){
dn.el_alertPanel.style.display="none";
}),In&&bt.on(dn.input,"click",function(){
d(document.getElementById("js_emotion_panel_pc"));
}),bt.on(dn.list,"click",".js_comment_praise",Y),bt.on(dn.mylist,"click",".js_comment_praise",Y),
bt.on(dn.fdlist,"click",".js_comment_praise",Y),bt.on(dn.list,"click",".js_reply_praise",Q),
bt.on(dn.fdlist,"click",".js_reply_praise",Q),bt.on(dn.mylist,"click",".js_reply_praise",Q),
bt.on(dn.list,"click",".js_del",X),bt.on(dn.mylist,"click",".js_del",X),bt.on(dn.fdlist,"click",".js_del",X),
bt.on(dn.mylist,"click",".js_reply_del",$),bt.on(dn.list,"click",".js_reply_del",$),
bt.on(dn.list,"click",".js_comment_reply",et),bt.on(dn.mylist,"click",".js_comment_reply",et),
bt.on(dn.list,"click",".js_extend_comment",tt),Ct.listenMpPageAction(function(e){
...
}),bt.on(dn.list,"click",".js_del",function(e){
e.preventDefault();
}),bt.on(dn.mylist,"click",".js_del",function(e){
e.preventDefault();
}),bt.on(dn.fdlist,"click",".js_del",function(e){
e.preventDefault();
}),bt.on(dn.submit,"click",N),bt.on(dn.submit,"click",function(e){
e.preventDefault();
}),dn.goback&&(bt.on(dn.goback,"click",nt),bt.on(dn.goback,"click",nt)),window.__second_open__&&gt.os.ios&&!function(){
bt.on(dn.input,"click",function(){
d(dn.fakebar);
}),bt.on(dn.input,"blur",function(){
...
dn.mine.style.height=Ct.getInnerHeight()+"px",window.scrollBy&&window.scrollBy(0,1),
t=setTimeout(function(){
window.scrollBy&&window.scrollBy(0,-1),dn.mine.style.height="";
},100));
},50));
});
}(),bt.on(window,"scroll",j),window.hasRelatedArticleInfo&&bt.on(window,"scroll",v),
...
ot(e);
}),bt.on(dn.inputPC,"click",function(){
...
wn=!1,l(dn.containerPC),lt(dn.containerPC)&&it(dn.containerPC),K();
}),bt.bindVisibilityChangeEvt(function(e){
e&&Ct.getScrollTop()<ft.getOffset(dn.cmtContainer).offsetTop-Ct.getInnerHeight()&&x({
forceRefresh:!0,
cb:T
});
}),bt.on(dn.showAllWording,"tap",function(e){
e.preventDefault(),d(dn.showAll),l(document.getElementById("js_cmt_statement")),
dn.listContainer.style.height="auto",St.report(18832,_extends({
Actiontype:2,
Type:3,
Bizuin:0,
Msgid:0,
...
if(e.addRange)e.removeAllRanges(),e.addRange(jn);else{
var t=jt.getRange();
t.setEndPoint&&(t.setEndPoint("EndToEnd",jn),t.setEndPoint("StartToStart",jn)),t.select();
}
}
}
function o(){
...
dn.submit.disabled=!0):1>e?(w.style.display="none",ct.removeClass(w,"comment_primary_counter_warn"),
dn.submit.disabled=!0):(w.style.display="none",ct.removeClass(w,"comment_primary_counter_warn"),
...
var i=n.createContextualFragment(e),l=i.lastChild,d=jt.getSelection();
...
}),bt.on(dn.input,"keyup",function(){
t(),m();
}),bt.on(dn.input,"keydown",function(e){
return 13===e.keyCode?(t(),p("<br/>"),t(),!1):void 0;
}),bt.on(dn.input,"mouseup",function(){
t(),m();
}),bt.on(dn.input,"paste",function(){
...
if((!wn&&!a(t,dn.addbtnPC)||wn&&!a(t,dn.containerPC))&&"none"!==dn.containerPC.style.display){
var o=dn.input.innerHTML;
""===g(o)&&(d(dn.containerPC),l(dn.inputPC),d(n));
}
a(t,n)||a(t,dn.emotionSwitchPC)||"none"===n.style.display||d(n);
},!1),bt.on(dn.expandAndFoldPC,"click",function(){
fn?(b(2),ct.removeClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="展开我的留言",r(),fn=!1,b(1)):(b(2),ct.addClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="收起我的留言",c(),fn=!0,b(1));
...
ct.addClass(document.body,"pages_skin_pc")):i("js_cmt_addbtn_pc"),dn={
...
},window.__second_open__&&gt.os.ios&&(dn.mine.style.marginBottom=getComputedStyle(dn.fakebar).height),
